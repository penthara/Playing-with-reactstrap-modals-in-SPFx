...
const ModalWithTransition = ({modal, hide}) =>{
    return (
      <div>
       
        <Modal isOpen={modal} toggle={hide}
        modalTransition={{ timeout: 5000 }}
        backdropTransition={{ timeout: 8000 }}  
         >
          <ModalHeader toggle={hide}>Modal With Transition</ModalHeader>
          <ModalBody>
